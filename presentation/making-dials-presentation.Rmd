...
knitr::include_graphics("./speed-dial-rotated.jpg")
knitr::include_graphics("./8630-F.jpg")
```
...
## Attempt #3: R - base graphics

- Create an SVG file
- Find a circular plotting package

## Selecting a Circular Visualization Package

Circos, originally in Perl, was created by Martin Krzywinski, who announced in 2009 with this brilliant paper: [“Circos: an Information Aesthetic for Comparative Genomics”](https://genome.cshlp.org/content/early/2009/06/15/gr.092759.109.abstract).
...
```{r pokemon}
knitr::include_graphics("./circular-pokemon-1.png")
```

##

```{r doodle}
knitr::include_graphics("./doodle.jpeg")
```

##  

```{r death-star}
knitr::include_graphics("./too-much-data-example.jpeg")
```

---

```{r clock}
knitr::include_graphics("./clock-1.svg")
```

## 

```{r separate_nested_plots}
knitr::include_graphics("./circlize-nested-1.svg")
```
