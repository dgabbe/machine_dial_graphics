...
## Compute Angles for Speeds

Next is calculating the angular position on the scale. Assume that the angle calculated is the center of the text. The end points are calculated seperately because they are subject to end point rounding.
...
Dial rotational spacing is accurate. Added outer circle diameter dimension, but need to verify scaling.
...
circos.text(speeds1, rep(0.6, length(speeds1)), speeds1, facing = "inside", cex = fontsize(font_size))
circos.clear()

# Add center mark
lines(x = c(-0.1, 0.1), y = c(0, 0), fg = "light gray")
lines(x = c(0, 0), y = c(-0.1, 0.1), fg = "light gray")
...
circos.track(ylim = c(0, 1), 
             panel.fun = function(x, y) {
               circos.text(speeds2, rep(0.6, length(speeds2)), speeds2, facing = "inside", cex = fontsize(font_size))
             }
)
circos.clear()
...
circos.track(ylim = c(0, 1),
             bg.col = "red",
             panel.fun = function(x, y) {
               circos.text(speeds3, rep(0.6, length(speeds3)), speeds3, facing = "inside", cex = fontsize(font_size))
             }
)
circos.clear()
...
circos.track(ylim = c(0, 1),
             panel.fun = function(x, y) {
               circos.text(speeds4, rep(0.6, length(speeds4)), speeds4, facing = "inside", cex = fontsize(font_size))
             }
)
circos.clear()
