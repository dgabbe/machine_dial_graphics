...
rpm_scale <- function(freq_scale, pulley_ratio, motor_rpm = motor_rpms) {
  return(round(motor_rpm * pulley_ratio * freq_scale / 60))
}

rpms <- rpm_scale(freq_scale = hertz_scale, pulley_multipler[1])
rpms
rpms <- rpm_scale(freq_scale = hertz_scale, pulley_multipler[2])
rpms
rpms <- rpm_scale(freq_scale = hertz_scale, pulley_multipler[3])
rpms
rpms <- rpm_scale(freq_scale = hertz_scale, pulley_multipler[4])
rpms
