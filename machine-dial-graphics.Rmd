...
The idea is to programmatically design a speed dial to set the spindle RPM on a manual machine tool. In my case, a Delta DP220 drill press. Here's a two speed dial for a Bridgeport Mill. 
...
```{r scale-values}
s1 <- c(170, 200, 250, 300, 350, 400, 450, 500, 555)
```
